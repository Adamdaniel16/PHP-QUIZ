...
try{
    ...
    // insertion questions
    $questions=array(
        new QuestionText('text','Citez le chiffre de pi','3.142',1),
        new QuestionCheckbox('checkbox','Qeul(les) sont le(s) couleur(s) primaire(s) ?',array('Bleu','Rouge','Jaune'),1,array('Vert','Blanc','Bleu','Rouge','Noir','Jaune')),
        new QuestionRadio('radio',"Quel est le symbole chimique de l'or ?",'Au',1,array('H2O','Gd','Au','Or')),
    );
